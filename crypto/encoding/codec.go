...
func init() {
	json.RegisterType((*pc.PublicKey)(nil), "hotstuff.crypto.PublicKey")
	json.RegisterType((*pc.PublicKey_Ed25519)(nil), "hotstuff.crypto.PublicKey_Ed25519")
	json.RegisterType((*pc.PublicKey_Secp256K1)(nil), "hotstuff.crypto.PublicKey_Secp256K1")
}
