...
https://github.com/xufeisofly/hotstuff-core/blob/v0.34.x/spec/consensus/light-client/verification.md
for details.
...
for usage example.
Or see
https://github.com/xufeisofly/hotstuff-core/tree/v0.34.x/spec/consensus/light-client
for the full spec
*/
package light
