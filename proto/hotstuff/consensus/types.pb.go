...
type TimeoutMessage struct {
	...
	HighQc          *types.QuorumCert `protobuf:"bytes,5,opt,name=high_qc,json=highQc,proto3" json:"high_qc,omitempty"`
	ViewSignature   []byte            `protobuf:"bytes,6,opt,name=view_signature,json=viewSignature,proto3" json:"view_signature,omitempty"`
	HighQcSignature []byte            `protobuf:"bytes,7,opt,name=high_qc_signature,json=highQcSignature,proto3" json:"high_qc_signature,omitempty"`
}

func (m *TimeoutMessage) Reset()         { *m = TimeoutMessage{} }
func (m *TimeoutMessage) String() string { return proto.CompactTextString(m) }
func (*TimeoutMessage) ProtoMessage()    {}
func (*TimeoutMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_46763c6512651b24, []int{2}
}
func (m *TimeoutMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TimeoutMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TimeoutMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TimeoutMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TimeoutMessage.Merge(m, src)
}
func (m *TimeoutMessage) XXX_Size() int {
	return m.Size()
}
func (m *TimeoutMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_TimeoutMessage.DiscardUnknown(m)
}

var xxx_messageInfo_TimeoutMessage proto.InternalMessageInfo

func (m *TimeoutMessage) GetSender() []byte {
	if m != nil {
		return m.Sender
	}
	return nil
...
func (m *TimeoutMessage) GetView() int64 {
	if m != nil {
		return m.View
	}
	return 0
...
func (m *TimeoutMessage) GetViewHash() []byte {
	if m != nil {
		return m.ViewHash
	}
	return nil
...
func (m *TimeoutMessage) GetEpochView() int64 {
	if m != nil {
		return m.EpochView
	}
	return 0
...
func (m *TimeoutMessage) GetHighQc() *types.QuorumCert {
	if m != nil {
		return m.HighQc
	}
	return nil
...
func (m *TimeoutMessage) GetViewSignature() []byte {
	if m != nil {
		return m.ViewSignature
	}
	return nil
}

func (m *TimeoutMessage) GetHighQcSignature() []byte {
	if m != nil {
		return m.HighQcSignature
	}
	return nil
}

type NewViewMessage struct {
	SyncInfo types.SyncInfo `protobuf:"bytes,1,opt,name=sync_info,json=syncInfo,proto3" json:"sync_info"`
}
...
func (m *NewViewMessage) GetSyncInfo() types.SyncInfo {
	if m != nil {
		return m.SyncInfo
	}
...
func (*VoteSetBits) Descriptor() ([]byte, []int) {
	return fileDescriptor_46763c6512651b24, []int{12}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_46763c6512651b24, []int{13}
}
...
type Message_HsProposal struct {
	HsProposal *ProposalMessage `protobuf:"bytes,10,opt,name=hs_proposal,json=hsProposal,proto3,oneof" json:"hs_proposal,omitempty"`
}
type Message_HsVote struct {
	HsVote *VoteMessage `protobuf:"bytes,11,opt,name=hs_vote,json=hsVote,proto3,oneof" json:"hs_vote,omitempty"`
}
...
func (*Message_HsProposal) isMessage_Sum()    {}
func (*Message_HsVote) isMessage_Sum()        {}
...
func (m *Message) GetHsProposal() *ProposalMessage {
	if x, ok := m.GetSum().(*Message_HsProposal); ok {
		return x.HsProposal
	}
	return nil
}

func (m *Message) GetHsVote() *VoteMessage {
	if x, ok := m.GetSum().(*Message_HsVote); ok {
		return x.HsVote
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*TimeoutMessage)(nil), "hotstuff.consensus.TimeoutMessage")
	proto.RegisterType((*NewViewMessage)(nil), "hotstuff.consensus.NewViewMessage")
...
var fileDescriptor_46763c6512651b24 = []byte{
	...
	,
}
...
func (m *TimeoutMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TimeoutMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TimeoutMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.HighQcSignature) > 0 {
		i -= len(m.HighQcSignature)
		copy(dAtA[i:], m.HighQcSignature)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.HighQcSignature)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ViewSignature) > 0 {
		i -= len(m.ViewSignature)
		copy(dAtA[i:], m.ViewSignature)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ViewSignature)))
		i--
		dAtA[i] = 0x32
	}
	if m.HighQc != nil {
		{
			size, err := m.HighQc.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.EpochView != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.EpochView))
		i--
		dAtA[i] = 0x20
	}
	if len(m.ViewHash) > 0 {
		i -= len(m.ViewHash)
		copy(dAtA[i:], m.ViewHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ViewHash)))
		i--
		dAtA[i] = 0x1a
	}
	if m.View != 0 {
...
func (m *Message_HsProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_HsProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.HsProposal != nil {
		{
			size, err := m.HsProposal.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_HsVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_HsVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.HsVote != nil {
		{
			size, err := m.HsVote.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TimeoutMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.EpochView != 0 {
		n += 1 + sovTypes(uint64(m.EpochView))
	}
	if m.HighQc != nil {
		l = m.HighQc.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.ViewSignature)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.HighQcSignature)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
...
func (m *Message_HsProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_HsVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TimeoutMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TimeoutMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TimeoutMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViewHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ViewHash = append(m.ViewHash[:0], dAtA[iNdEx:postIndex]...)
			if m.ViewHash == nil {
				m.ViewHash = []byte{}
			}
			iNdEx = postIndex
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighQc", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.HighQc == nil {
				m.HighQc = &types.QuorumCert{}
			}
			if err := m.HighQc.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViewSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ViewSignature = append(m.ViewSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.ViewSignature == nil {
				m.ViewSignature = []byte{}
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighQcSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HighQcSignature = append(m.HighQcSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.HighQcSignature == nil {
				m.HighQcSignature = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HsProposal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Sum = &Message_HsProposal{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HsVote", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
