...
// source: hotstuff/types/types.proto
...
import (
	...
	version "github.com/xufeisofly/hotstuff/proto/hotstuff/version"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func (BlockIDFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{0}
}
...
func (SignedMsgType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{1}
}
...
func (*BlockID) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{2}
}
...
// Header defines the structure of a Hotstuff block header.
type Header struct {
	// basic block info
	...
	QuorumCert  *QuorumCert `protobuf:"bytes,16,opt,name=quorum_cert,json=quorumCert,proto3" json:"quorum_cert,omitempty"`
	SelfCommit  *HsCommit   `protobuf:"bytes,17,opt,name=self_commit,json=selfCommit,proto3" json:"self_commit,omitempty"`
	ResultsHash []byte      `protobuf:"bytes,18,opt,name=results_hash,json=resultsHash,proto3" json:"results_hash,omitempty"`
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{3}
}
...
func (m *Header) GetQuorumCert() *QuorumCert {
	if m != nil {
		return m.QuorumCert
	}
	return nil
...
func (m *Header) GetSelfCommit() *HsCommit {
	if m != nil {
		return m.SelfCommit
	}
	return nil
...
func (*QuorumCert) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{4}
}
...
func (m *QuorumCert) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *QuorumCert) GetView() int64 {
	if m != nil {
		return m.View
	}
	return 0
...
func (m *QuorumCert) GetBlockID() BlockID {
	if m != nil {
		return m.BlockID
	}
	return BlockID{}
...
func (*TimeoutCert) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{5}
}
...
func (m *TimeoutCert) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *TimeoutCert) GetView() int64 {
	if m != nil {
		return m.View
	}
	return 0
...
func (m *AggregateQC) Reset()         { *m = AggregateQC{} }
func (m *AggregateQC) String() string { return proto.CompactTextString(m) }
func (*AggregateQC) ProtoMessage()    {}
func (*AggregateQC) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{6}
}
func (m *AggregateQC) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AggregateQC) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AggregateQC.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AggregateQC) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AggregateQC.Merge(m, src)
}
func (m *AggregateQC) XXX_Size() int {
	return m.Size()
}
func (m *AggregateQC) XXX_DiscardUnknown() {
	xxx_messageInfo_AggregateQC.DiscardUnknown(m)
}

var xxx_messageInfo_AggregateQC proto.InternalMessageInfo
...
func (*Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{7}
}
...
// consensus.
type Vote struct {
	Type             SignedMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=hotstuff.types.SignedMsgType" json:"type,omitempty"`
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{8}
}
...
func (*Commit) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{9}
}
...
type HsCommit struct {
	CommitQc QuorumCert `protobuf:"bytes,1,opt,name=commit_qc,json=commitQc,proto3" json:"commit_qc"`
}

func (m *HsCommit) Reset()         { *m = HsCommit{} }
func (m *HsCommit) String() string { return proto.CompactTextString(m) }
func (*HsCommit) ProtoMessage()    {}
func (*HsCommit) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{10}
}
func (m *HsCommit) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HsCommit) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HsCommit.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HsCommit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HsCommit.Merge(m, src)
}
func (m *HsCommit) XXX_Size() int {
	return m.Size()
}
func (m *HsCommit) XXX_DiscardUnknown() {
	xxx_messageInfo_HsCommit.DiscardUnknown(m)
}

var xxx_messageInfo_HsCommit proto.InternalMessageInfo

func (m *HsCommit) GetCommitQc() QuorumCert {
	if m != nil {
		return m.CommitQc
	}
	return QuorumCert{}
...
type CommitSig struct {
	BlockIdFlag      BlockIDFlag `protobuf:"varint,1,opt,name=block_id_flag,json=blockIdFlag,proto3,enum=hotstuff.types.BlockIDFlag" json:"block_id_flag,omitempty"`
...
func (*CommitSig) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{11}
}
...
func (*Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{12}
}
...
func (*SignedHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{13}
}
...
func (*LightBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{14}
}
...
func (*BlockMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{15}
}
...
func (*TxProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_1def37d0d78bc02e, []int{16}
}
...
func init() {
	proto.RegisterEnum("hotstuff.types.BlockIDFlag", BlockIDFlag_name, BlockIDFlag_value)
	proto.RegisterEnum("hotstuff.types.SignedMsgType", SignedMsgType_name, SignedMsgType_value)
	proto.RegisterType((*PartSetHeader)(nil), "hotstuff.types.PartSetHeader")
	proto.RegisterType((*Part)(nil), "hotstuff.types.Part")
	proto.RegisterType((*BlockID)(nil), "hotstuff.types.BlockID")
	proto.RegisterType((*Header)(nil), "hotstuff.types.Header")
	proto.RegisterType((*QuorumCert)(nil), "hotstuff.types.QuorumCert")
	proto.RegisterType((*TimeoutCert)(nil), "hotstuff.types.TimeoutCert")
	proto.RegisterType((*AggregateQC)(nil), "hotstuff.types.AggregateQC")
	proto.RegisterType((*Data)(nil), "hotstuff.types.Data")
	proto.RegisterType((*Vote)(nil), "hotstuff.types.Vote")
	proto.RegisterType((*Commit)(nil), "hotstuff.types.Commit")
	proto.RegisterType((*HsCommit)(nil), "hotstuff.types.HsCommit")
	proto.RegisterType((*CommitSig)(nil), "hotstuff.types.CommitSig")
	proto.RegisterType((*Proposal)(nil), "hotstuff.types.Proposal")
	proto.RegisterType((*SignedHeader)(nil), "hotstuff.types.SignedHeader")
	proto.RegisterType((*LightBlock)(nil), "hotstuff.types.LightBlock")
	proto.RegisterType((*BlockMeta)(nil), "hotstuff.types.BlockMeta")
	proto.RegisterType((*TxProof)(nil), "hotstuff.types.TxProof")
}

func init() { proto.RegisterFile("hotstuff/types/types.proto", fileDescriptor_1def37d0d78bc02e) }

var fileDescriptor_1def37d0d78bc02e = []byte{
	...
	,
}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SelfCommit != nil {
		{
			size, err := m.SelfCommit.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AggregateQC) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AggregateQC) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AggregateQC) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HsCommit) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HsCommit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HsCommit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.CommitQc.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelfCommit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SelfCommit == nil {
				m.SelfCommit = &HsCommit{}
			}
			if err := m.SelfCommit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
...
func (m *AggregateQC) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AggregateQC: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AggregateQC: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *HsCommit) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HsCommit: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HsCommit: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitQc", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CommitQc.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
